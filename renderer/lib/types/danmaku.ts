...
export class GiftMessage {
  ...
  constructor(body: any) {
    ...
    this.gift_info = {
      id: body.data.giftId,
      name: body.data.giftName,
      price: body.data.price,
    }
    this.sender.uid = body.data.uid
    this.sender.uname = body.data.uname
...
export class SuperChatMessage {
  ...
  constructor(body: any) {
    ...
    this.sender.uid = body.data.uid
    this.sender.uname = body.data.user_info.uname
    this.sender.face = body.data.user_info.face
    this.sender.medal_info = body.data.medal_info ? {
        anchor_roomid: body.data.medal_info.anchor_roomid,
        anchor_uname: body.data.medal_info.anchor_uname,
        medal_name: body.data.medal_info.medal_name,
        medal_level: body.data.medal_info.medal_level,
        medal_color: body.data.medal_info.medal_color,
        medal_color_border: body.data.medal_info.medal_color_border,
        medal_color_start: body.data.medal_info.medal_color_start,
        medal_color_end: body.data.medal_info.medal_color_end,
        guard_level: body.data.medal_info.guard_level,
        is_lighted: body.data.medal_info.is_lighted
    } : null
